...
from rsiseg.utils.misc import prepare_dir
...
def main():
    ...
    # cfg['runner']['max_iters'] = 400_000
    cfg['runner']['max_iters'] = 80_000
    # cfg['runner']['max_iters'] = 50_000
    ...
    # Save config params
    config_save_path = f'{cfg.work_dir}/config_params.txt'
    prepare_dir(config_save_path)
    ...
    # print(f'Checkpoint file loaded: {parsed_args.load_from}')
    # cfg.model['pretrained'] = parsed_args.load_from
